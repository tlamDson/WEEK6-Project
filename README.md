# Web Development Project 6 - _Cooking Recipe_

Submitted by: **Lam Pham**

This web app: **Using react-router for navgigation and added a page of details of the dish that can be access via useParams()**
