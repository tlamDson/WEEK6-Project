...
const FavoritesList = ({
  ...
  onRemoveFromFavorites: propRemove,
}) => {
  // Use localStorage if no props provided
  const [favorites, setFavorites] = useState(
    () => propFavorites || getFavoriteRecipes()
  );
  ...
  const safeBookmarks = Array.isArray(favorites) ? favorites : [];

  const favoritesWithRemoveAction = safeBookmarks.map((recipe) => ({
    ...recipe,
    removeAction: true,
  }));
    ...
    <div className="favorites-container">
      <div className="favorites-header">
        ...
        <p className="favorites-subtitle">
          You have {safeBookmarks.length} favorite recipe
          {safeBookmarks.length !== 1 ? "s" : ""}
        </p>
      </div>
