      ...
      <div className="api-info-container">
        ...
        <div className="api-info-content">
          <div className="api-overview">
            ...
            <p>
              We use the <strong>Spoonacular Food API</strong> to provide you
              with comprehensive recipe information. This powerful API offers
              access to over 5,000 recipes with detailed nutritional
              information, cooking instructions, and ingredient lists.
            </p>
          ...
          <div className="api-characteristics">
            ...
            <div className="characteristics-grid">
              <div className="characteristic-card">
                ...
                <p>
                  Each recipe includes detailed nutritional information
                  including health scores (0-100), calorie counts,
                  macronutrients, and dietary compatibility markers (vegan,
                  gluten-free, etc.).
                </p>
                <ul>
              ...
              <div className="characteristic-card">
                ...
                <p>
                  Detailed ingredient lists with pricing information per
                  serving, helping you budget your meals and understand the
